...
async def generate_podcast_command(
  ...
  try:
    ...
    episode = PodcastEpisode(
      ...
      command=ensure_record_id(input_data.execution_context.command_id) if input_data.execution_context else None,
      briefing=briefing,
    ...
    return PodcastGenerationOutput(success=False, processing_time=processing_time, error_message=str(e))
