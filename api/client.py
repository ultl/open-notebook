...
class APIClient:
  ...
  def _make_request(self, method: str, endpoint: str, timeout: float | None = None, **kwargs) -> dict:
    ...
    try:
      ...
      msg = f'API request failed: {e.response.status_code} - {e.response.text}'
  ...
  def get_notebooks(self, archived: bool | None = None, order_by: str = 'updated desc') -> list[dict]:
    """Get all notebooks."""
  ...
  # Models API methods
  def get_models(self, model_type: str | None = None) -> list[dict]:
  ...
  def execute_transformation(self, transformation_id: str, input_text: str, model_id: str) -> dict:
  ...
  # Notes API methods
  def get_notes(self, notebook_id: str | None = None) -> list[dict]:
  ...
  # Context API methods
  def get_notebook_context(self, notebook_id: str, context_config: dict | None = None) -> dict:
  ...
  # Sources API methods
  def get_sources(self, notebook_id: str | None = None) -> list[dict]:
  ...
  def save_insight_as_note(self, insight_id: str, notebook_id: str | None = None) -> dict:
  ...
  def create_source_insight(self, source_id: str, transformation_id: str, model_id: str | None = None) -> dict:
