...
class PodcastAPIService:
  ...
  def duplicate_episode_profile(self, profile_id: str) -> bool:
    ...
    try:
      api_client._make_request('POST', f'/api/episode-profiles/{profile_id}/duplicate')
      return True
    except Exception as e:
  ...
  def update_speaker_profile(self, profile_id: str, profile_data: dict) -> bool:
    ...
    try:
      api_client._make_request('PUT', f'/api/speaker-profiles/{profile_id}', json=profile_data)
      return True
    except Exception as e:
  ...
  def duplicate_speaker_profile(self, profile_id: str) -> bool:
    ...
    try:
      api_client._make_request('POST', f'/api/speaker-profiles/{profile_id}/duplicate')
      return True
    except Exception as e:
